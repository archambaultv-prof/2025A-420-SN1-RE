...
const config = {
  title: '2025A-420-SN1-RE',
  tagline: 'Programmation en sciences',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/archambaultv-prof/2025A-420-SN1-RE/tree/main/',
        },
        blog: false,
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/archambaultv-prof/2025A-420-SN1-RE/',
            label: 'GitHub',
            position: 'right',
          },
        ],
